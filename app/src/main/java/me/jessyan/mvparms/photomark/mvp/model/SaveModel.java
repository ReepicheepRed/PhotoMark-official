...
@ActivityScope
public class SaveModel extends BaseModel<ServiceManager, CacheManager> implements SaveContract.Model {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public SaveModel(ServiceManager serviceManager, CacheManager cacheManager, Gson gson, Application application) {
