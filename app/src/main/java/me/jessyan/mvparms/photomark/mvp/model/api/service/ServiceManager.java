...
public class ServiceManager implements BaseServiceManager {
    ...
    private PosterService mPosterService;
     ...
     */
    @Inject
    public ServiceManager(CommonService commonService,UserService userService,PosterService posterService){
        this.mCommonService = commonService;
        this.mUserService = userService;
        this.mPosterService = posterService;
    }
