...
@ActivityScope
class SettingModel @Inject
constructor(serviceManager: ServiceManager, cacheManager: CacheManager, private var mGson: Gson?, private var mApplication: Application?) : BaseModel<ServiceManager, CacheManager>(serviceManager, cacheManager), SettingContract.Model {
