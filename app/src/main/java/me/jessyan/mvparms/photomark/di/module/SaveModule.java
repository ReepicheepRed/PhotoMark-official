...
import me.jessyan.mvparms.photomark.mvp.model.SaveModel;
...
public class SaveModule {
    ...
    /**
     * 构建SaveModule时,将View的实现类传进来,这样就可以提供View的实现类给presenter
     * @param view
     */
    ...
    @ActivityScope
    @Provides
    SaveContract.View provideSaveView() {
        return this.view;
    }

    @ActivityScope
    @Provides
    SaveContract.Model provideSaveModel(SaveModel model) {
        return model;
    }
}